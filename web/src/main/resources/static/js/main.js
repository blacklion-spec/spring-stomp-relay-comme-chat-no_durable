...
function onConnected() {
    ...
    stompClient.subscribe('/topic/chat.sendMessage', onMessageReceived, {
        'x-queue-name': username + '-queue',
        ack: 'client-individual'
    });
    stompClient.send("/topic/chat.sendMessage",
        {},
...
function onMessageReceived(payload) {
    ...
    var messageText = document.createTextNode('消息 ' + new Date().Format("yyyy-MM-dd HH:mm:ss") + '：' + message.content);
